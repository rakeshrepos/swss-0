...
function Question4({userId,credictScore,setCreditScore,step,setStep}) {
    ...
    const storeCreditStore = (credictScoreValue)=>{
        ...
        try{
            axios.post('http://localhost:8000/api/store-creditscore', {user_id:userId,credit_score:credictScoreValue})
