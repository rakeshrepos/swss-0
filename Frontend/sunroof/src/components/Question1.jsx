...
function Question1({userId,address,setAddress,appartment,setAppartment,step,setStep}) {
    ...
    const storeAppartment = ()=>{
      try{
          axios.post('http://localhost:8000/api/store-location', {user_id:userId,appartment:appartment})
  ...
  return (
    <div className='w-screen lg:w-[50rem] lg:px-[6rem] py-[3rem]'>
        ...
        <div className="grid grid-cols-2 mt-5 ">
            ...
            <button onClick={()=>{storeAppartment()}} className='flex justify-center items-center bg-[#03a9f4] w-full text-white text-xl font-bold h-[3rem]'>
                <p>NEXT</p>
                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-6 h-6">
